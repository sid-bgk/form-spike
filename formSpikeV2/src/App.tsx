...
import { UserRegistrationStepsFormik } from '@/pages/formIk/UserRegistrationStepsFormik'
    ...
    <Router>
      <div className="min-h-screen bg-gray-50">
        ...
        <Routes>
          ...
          <Route path="/user-registration-steps-formik" element={<UserRegistrationStepsFormik />} />
