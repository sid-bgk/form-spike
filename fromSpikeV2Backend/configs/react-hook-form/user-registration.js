module.exports = {
  version: 1,
  form: {
    title: "User Registration (Config File) - react-hook-form",
    description: "Config served from backend file system using React Hook Form",
    ...
    fields: [
      ...
      // Companies Information - shows only if working
      {
        ...
        description:
          "Add information for each company you work or have worked for",
        arrayItemFields: [
          {
            name: "companyName",
            label: "Company Name",
          ...
          },
          {
            ...
            validation: {
              ...
              maxLength: {
                value: 80,
                message: "Designation cannot exceed 80 characters",
              },
            },
          ...
          },
          {
            ...
            validation: {
              ...
              max: {
                value: 50,
                message: "Please enter a realistic number of years",
              },
            },
            placeholder: "3",
          },
