...
// Custom validation rules for cross-field validation (Formik specific)
...
module.exports = {
    ...
    form: {
        ...
        description: "Step-based configuration served from backend file system using Formik + Yup validation",
        ...
        steps: [
            ...
            },
            {
                ...
                fields: [
                    ...
                    // Note: Previous employer fields would be added here based on worked2Years computed value
                    // For brevity, including just the basic income fields
                ],
            },
            {
